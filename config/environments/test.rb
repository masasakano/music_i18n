...
Rails.application.configure do
  ...
  # config.action_mailer.default_url_options = { host: "localhost", port: 3000 } # Originally added by User for Devise (though Rails-8.0 default written above may be better?)
