...
Rails.application.configure do
  ...
  # Tell Active Support which deprecation messages to disallow. (Added by User)
  ...
  # Originally added by User for Devise (the line is now included in default in Rails-8.0 if with example.com - this must be machine's IP and true port number.
