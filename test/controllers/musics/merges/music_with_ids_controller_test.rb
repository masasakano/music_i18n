...
class Musics::Merges::MusicWithIdsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get index if logged in as an editor" do
    get musics_merges_music_with_ids_path(@music,  params: {keyword: "ivepea", path: "/en/musics/#{@music.id}/merges/new"}, format: :json, locale: I18n.locale)
    assert_response 401  # Unauthorized

    sign_in @editor
    fpath = '/en/random'
    get musics_merges_music_with_ids_path(@music,  params: {keyword: "ivepea", path: fpath}, format: :json, locale: I18n.locale)
