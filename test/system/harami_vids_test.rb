...
class HaramiVidsTest < ApplicationSystemTestCase
  ...
  test "visiting-HaramiVid#edit" do
    ...
    anchor_url = "https://example.com/"+tit2
    ...
    turbo_id = dom_id(hvid2)+"_anchorings"
    assert_selector :xpath, "//*[@id='anchoring_index_HaramiVid']//turbo-frame[@id='#{turbo_id}']"
    ...
    ## Destroy Anchoring
    visit harami_vid_path(hvid2)
    assert_selector "#anchoring_index_HaramiVid ul li a"  # Anchoring should exist
